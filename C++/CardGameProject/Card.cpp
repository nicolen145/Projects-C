...
//Static card variable for operator[] in deck class , when it receives invalid index it will return this card.
Card Card::Invalid_Card = Card('X', 'X');
...
bool Card::compere(const Card& other,const char* opr)const
{
...
void Card::set_rank(char r)
{
	rank = r;
	value = this->set_value(r);
}
void Card::set_symbol(char s)
{
	symbol = s;
}
